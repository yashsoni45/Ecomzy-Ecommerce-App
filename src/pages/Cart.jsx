...
useEffect(() => {
  ...
  return (
    <div >
      {
        cart.length > 0 ?
         (<div className="flex flex-row justify-between gap-16 max-w-6xl p-6 mx-auto flex-wrap lg:flex-nowrap">
              ...
              <div className="lg:w-[70%]">
                ...
                <div className='flex flex-col  gap-20 justify-items-center'>
